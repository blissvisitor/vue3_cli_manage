...
export default {
	...
	// 保存附件（文件信息入库）
	saveOrUpFiles: `${SERVICES}/common/dseUploadFilesCtrl/saveOrUpFiles`,
	// 获取（查询附件列表）
	getDseUploadFileList: `${SERVICES}/common/dseUploadFilesCtrl/getDseUploadFileList`,
	// 获取文件路径前缀
	getFilePathUrl: `${SERVICES}/nyCommonCtrl/getFilePathUrl`,
	// 根据业务主键删除附件（针对已经入库的附件）
	deleteFilesByFileBiz: `${SERVICES}/common/dseUploadFilesCtrl/deleteFilesByFileBiz`,	
	// 根据附件ID 删除附件
	deleteFileById: `${SERVICES}/common/dseUploadFilesCtrl/deleteFileById`,	
	...
	// 获取 图片路径前缀
	getFilePathUrl_img:`${SERVICES}/nyCommonCtrl/getFilePathUrl`,
	// 模糊搜索
	// 一张图模糊搜索
	...
	// 左侧面板
	// 获取 四率一览的数据
	getGszbtj:`${SERVICES}/qxglCtrl/getGszbtj`,
	...
	// 监测监测点编码是否存在
	checkExistJcdB: `${SERVICES}/dseStJcdBCtrl/checkExist`,
	// 系统配置  获取监测点监测项列表
